  ...
  switch (MHSettings::GetNumPositions()) {
    case 4:
      ...
      if (right_button_down)
        BitBlt(hdc, 100, 0, 100, 100, hdc4red, 100, 0, SRCCOPY);

      switch (position) {
        case 0:  // стрелка вверх
          BitBlt(hdc, 0, 0, 200, 100, hdc4, 200, 0, SRCCOPY);
          if (left_button_down)
            BitBlt(hdc, 0, 0, 100, 100, hdc4red, 200, 0, SRCCOPY);
          if (right_button_down)
            BitBlt(hdc, 100, 0, 100, 100, hdc4red, 300, 0, SRCCOPY);
          break;
        case 1:  // стрелка вправо
          if (right_button_down)
            BitBlt(hdc, 100, 0, 100, 200, hdc4red, 100, 199, SRCCOPY);
          else
        ...
        case 3:  // стрелка влево
          if (left_button_down)
            BitBlt(hdc, 0, 0, 100, 200, hdc4red, 0, 199, SRCCOPY);
          else
    ...
    case 8:
      ...
      if (right_button_down)
        BitBlt(hdc, 100, 0, 100, 100, hdc8red, 100, 0, SRCCOPY);

      switch (position) {
        case 0:  // стрелка вверх
          BitBlt(hdc, 0, 0, 200, 100, hdc8, 200, 0, SRCCOPY);
          if (left_button_down)
            BitBlt(hdc, 0, 0, 100, 100, hdc8red, 200, 0, SRCCOPY);
          if (right_button_down)
            BitBlt(hdc, 100, 0, 100, 100, hdc8red, 300, 0, SRCCOPY);
          break;
        case 2:  // стрелка вправо
          if (right_button_down)
            BitBlt(hdc, 100, 0, 100, 200, hdc8red, 100, 200, SRCCOPY);
          else
        ...
        case 6:  // стрелка влево
          if (left_button_down)
            BitBlt(hdc, 0, 0, 100, 200, hdc8red, 0, 200, SRCCOPY);
          else
        ...
        case 1:  // стрелка вверх-вправо
          if (right_button_down)
            BitBlt(hdc, 100, 0, 100, 100, hdc8red, 300, 201, SRCCOPY);
          else
        ...
        case 7:  // стрелка вверх-влево
          if (left_button_down)
            BitBlt(hdc, 0, 0, 100, 100, hdc8red, 200, 201, SRCCOPY);
          else

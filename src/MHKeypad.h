...
class MHKeypad {
 public:
  static void Init(WORD _scancode0,
                   WORD _scancode1,
                   WORD _scancode2,
                   WORD _scancode3,
                   WORD _scancode4,
  ...
  static bool Press4(
      int position,
      bool down,
      int shift = 0);  // теперь возвращает false если реального нажатия не было
                       // - это для правой кнопки мыни надо было
